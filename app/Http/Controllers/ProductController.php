    ...
    public function index(Request $request) {
        ...
        <div class='p-4 rounded bg-blue-200 flex items-center'>
            ...
            <div class='w-6/4 pl-4'>
                ...
                hx-trigger='click'
                onclick='if (confirm('Are you sure you want to proceed?')) { alert('Action confirmed!'); } else { alert('Action canceled!'); }'
                class='btn bg-red-500 text-white px-4 py-2 rounded hover:bg-red-700 transition duration-300'>Delete</button>
